    ...
    return (
        <Headless.Field
            ...
            className={clsx(
                className,
                // Base layout
                'grid grid-cols-[1.125rem_1fr] items-center gap-x-1 gap-y-1 sm:grid-cols-[1rem_1fr]',
                // Control layout
...
const colors = {
    ...
    primary:
        '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-primary)] [--checkbox-checked-border:var(--color-primary-dark)]/90',
