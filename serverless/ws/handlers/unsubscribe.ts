...
export const handler: APIGatewayProxyWebsocketHandlerV2 = async event => {
    try {
        ...
        const body = JSON.parse(event.body || '{}') as UnsubscribePayload;
        ...
        await Promise.all(subjects.map(subjectId => WebSocketStorage.unsubscribe(connectionId, userId, body.subjectType!, subjectId)));
        ...
        console.error('WebSocket unsubscribe failed:', error);
        return {
            statusCode: 500,
