...
describe('NameParser', () => {
    describe('parseAndStandardizeName', () => {
        ...
        test('handles complex multi-part names', () => {
            expect(NameParser.parseAndStandardizeName('Laura-Ann Maria Angelica Lopez-Garcia')).toBe(
                'Lopez-Garcia, Laura-Ann Maria Angelica'
            );
            expect(NameParser.parseAndStandardizeName('Juan Carlos Rivera Vega')).toBe('Vega, Juan Carlos Rivera');
            expect(NameParser.parseAndStandardizeName('Mary Elizabeth Anne Windsor-Mountbatten')).toBe(
                'Windsor-Mountbatten, Mary Elizabeth Anne'
            );
        });
